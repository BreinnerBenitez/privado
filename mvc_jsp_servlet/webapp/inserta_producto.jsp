...
<h1> formulario</h1>
	...
	<form name="form1" action="ControladorProductos" method="get">
     <input  type="hidden" name="instrucion" value="insertarBBDD">
		<table width="35%" border="0">
			<tr>
				<td width="13%"><label for="nombre">CodigoArticulo: </label></td>
				<td width="87%"><input type="text" name="codigoarticulo" id="codigoarticulo"></td>
			</tr>
			<tr>
